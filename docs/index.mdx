...
release. The configuration flow may ask for a Grid CO₂ intensity or a CO₂
...
| **[Reference cases](spec/index.mdx)** | Worked examples that pin down exactly how the engine attributes power. |
