...
| combined_levelized_charging_cost_rate | calculate_levelized_cost_rates |
| combined_levelized_device_operating_cost_rate | calculate_levelized_cost_rates |
| combined_levelized_consumption_cost_rate | calculate_levelized_cost_rates |
| combined_standby_cost_rate | calculate_levelized_cost_rates |
| combined_export_cost_rate | calculate_levelized_cost_rates |
...
| combined_total_charging_cost | accumulate_cost_rates |
| combined_total_consumption_cost | accumulate_cost_rates |
| combined_total_levelized_device_operating_cost | accumulate_levelized_cost_rates |
