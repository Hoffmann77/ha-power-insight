...
class TestMixedExportHouse(ReferenceCase):
    ...
    * Two dischargers with different levelized costs price the mix between
    ...
    def test_export_non_exporting_battery_source_adapters_charging_power(self):
        return TODO

    @expect("source_adapters_consumption_ratios")
    def test_export_non_exporting_battery_source_adapters_consumption_ratios(self):
        return TODO

    @expect("source_adapters_export_ratios")
    def test_export_non_exporting_battery_source_adapters_export_ratios(self):
        return TODO

    @expect("source_adapters_charging_ratios")
    def test_export_non_exporting_battery_source_adapters_charging_ratios(self):
        return TODO

    @expect("source_adapters_standby_ratios")
    def test_export_non_exporting_battery_source_adapters_standby_ratios(self):
        return TODO

    @expect("source_adapters_consumption_shares")
    def test_export_non_exporting_battery_source_adapters_consumption_shares(self):
        return TODO

    @expect("source_adapters_charging_shares")
    def test_export_non_exporting_battery_source_adapters_charging_shares(self):
        return TODO

    @expect("source_adapters_standby_shares")
    def test_export_non_exporting_battery_source_adapters_standby_shares(self):
        return TODO

    @expect("sink_adapters_consumption_shares")
    def test_export_non_exporting_battery_sink_adapters_consumption_shares(self):
        return TODO
    ...
    def test_export_non_exporting_battery_source_adapters_coe_rate(self):
        return TODO

    @expect("source_adapters_export_compensation_rates")
    def test_export_non_exporting_battery_source_adapters_export_compensation_rates(self):
        return TODO

    @expect("source_adapters_coo_rates")
    def test_export_non_exporting_battery_source_adapters_coo_rates(self):
        return TODO

    @expect("source_adapters_lcoo_rates")
    def test_export_non_exporting_battery_source_adapters_lcoo_rates(self):
        return TODO

    @expect("sink_adapters_coo_rates")
    def test_export_non_exporting_battery_sink_adapters_coo_rates(self):
        return TODO

    @expect("sink_adapters_lcoo_rates")
    def test_export_non_exporting_battery_sink_adapters_lcoo_rates(self):
        return TODO

    @expect("sink_adapters_avoided_cost_rates")
    def test_export_non_exporting_battery_sink_adapters_avoided_cost_rates(self):
        return TODO

    @expect("home_base_load_avoided_cost_rate")
    def test_export_non_exporting_battery_home_base_load_avoided_cost_rate(self):
        return TODO

    @expect("combined_coe")
    def test_export_non_exporting_battery_combined_coe(self):
        return TODO

    @expect("combined_lcoe")
    def test_export_non_exporting_battery_combined_lcoe(self):
        return TODO

    @expect("combined_consumption_cost_rate")
    def test_export_non_exporting_battery_combined_consumption_cost_rate(self):
        return TODO

    @expect("combined_levelized_consumption_cost_rate")
    def test_export_non_exporting_battery_combined_levelized_consumption_cost_rate(self):
        return TODO

    @expect("combined_charging_cost_rate")
    def test_export_non_exporting_battery_combined_charging_cost_rate(self):
        return TODO

    @expect("combined_levelized_export_cost_rate")
    def test_export_non_exporting_battery_combined_levelized_export_cost_rate(self):
        return TODO

    @expect("combined_levelized_standby_cost_rate")
    def test_export_non_exporting_battery_combined_levelized_standby_cost_rate(self):
        return TODO

    @expect("combined_device_operating_cost_rate")
    def test_export_non_exporting_battery_combined_device_operating_cost_rate(self):
        return TODO

    @expect("adapters_saving_rates")
    def test_export_non_exporting_battery_adapters_saving_rates(self):
        return TODO

    @expect("adapters_levelized_saving_rates")
    def test_export_non_exporting_battery_adapters_levelized_saving_rates(self):
        return TODO

    @expect("adapters_financial_return_rates")
    def test_export_non_exporting_battery_adapters_financial_return_rates(self):
        return TODO

    @expect("adapters_levelized_financial_return_rates")
    def test_export_non_exporting_battery_adapters_levelized_financial_return_rates(self):
        return TODO

    @expect("combined_financial_return_rate")
    def test_export_non_exporting_battery_combined_financial_return_rate(self):
        return TODO
    ...
    @expect("source_adapters_charging_power")
    def test_export_with_standby_source_adapters_charging_power(self):
        return TODO

    @expect("source_adapters_consumption_ratios")
    def test_export_with_standby_source_adapters_consumption_ratios(self):
        return TODO

    @expect("source_adapters_export_ratios")
    def test_export_with_standby_source_adapters_export_ratios(self):
        return TODO

    @expect("source_adapters_charging_ratios")
    def test_export_with_standby_source_adapters_charging_ratios(self):
        return TODO

    @expect("source_adapters_standby_ratios")
    def test_export_with_standby_source_adapters_standby_ratios(self):
        return TODO

    @expect("source_adapters_consumption_shares")
    def test_export_with_standby_source_adapters_consumption_shares(self):
        return TODO

    @expect("source_adapters_charging_shares")
    def test_export_with_standby_source_adapters_charging_shares(self):
        return TODO

    @expect("source_adapters_standby_shares")
    def test_export_with_standby_source_adapters_standby_shares(self):
        return TODO

    @expect("sink_adapters_consumption_shares")
    def test_export_with_standby_sink_adapters_consumption_shares(self):
        return TODO
    ...
    @expect("source_adapters_coe_rate")
    def test_export_with_standby_source_adapters_coe_rate(self):
        return TODO

    @expect("source_adapters_export_compensation_rates")
    def test_export_with_standby_source_adapters_export_compensation_rates(self):
        return TODO

    @expect("source_adapters_coo_rates")
    def test_export_with_standby_source_adapters_coo_rates(self):
        return TODO

    @expect("source_adapters_lcoo_rates")
    def test_export_with_standby_source_adapters_lcoo_rates(self):
        return TODO

    @expect("sink_adapters_coo_rates")
    def test_export_with_standby_sink_adapters_coo_rates(self):
        return TODO

    @expect("sink_adapters_lcoo_rates")
    def test_export_with_standby_sink_adapters_lcoo_rates(self):
        return TODO

    @expect("sink_adapters_avoided_cost_rates")
    def test_export_with_standby_sink_adapters_avoided_cost_rates(self):
        return TODO

    @expect("home_base_load_avoided_cost_rate")
    def test_export_with_standby_home_base_load_avoided_cost_rate(self):
        return TODO

    @expect("combined_coe")
    def test_export_with_standby_combined_coe(self):
        return TODO

    @expect("combined_lcoe")
    def test_export_with_standby_combined_lcoe(self):
        return TODO

    @expect("combined_consumption_cost_rate")
    def test_export_with_standby_combined_consumption_cost_rate(self):
        return TODO

    @expect("combined_levelized_consumption_cost_rate")
    def test_export_with_standby_combined_levelized_consumption_cost_rate(self):
        return TODO

    @expect("combined_charging_cost_rate")
    def test_export_with_standby_combined_charging_cost_rate(self):
        return TODO

    @expect("combined_levelized_export_cost_rate")
    def test_export_with_standby_combined_levelized_export_cost_rate(self):
        return TODO

    @expect("combined_levelized_standby_cost_rate")
    def test_export_with_standby_combined_levelized_standby_cost_rate(self):
        return TODO

    @expect("combined_device_operating_cost_rate")
    def test_export_with_standby_combined_device_operating_cost_rate(self):
        return TODO

    @expect("adapters_saving_rates")
    def test_export_with_standby_adapters_saving_rates(self):
        return TODO

    @expect("adapters_levelized_saving_rates")
    def test_export_with_standby_adapters_levelized_saving_rates(self):
        return TODO

    @expect("adapters_financial_return_rates")
    def test_export_with_standby_adapters_financial_return_rates(self):
        return TODO

    @expect("adapters_levelized_financial_return_rates")
    def test_export_with_standby_adapters_levelized_financial_return_rates(self):
        return TODO

    @expect("combined_financial_return_rate")
    def test_export_with_standby_combined_financial_return_rate(self):
        return TODO
    ...
    @expect("source_adapters_charging_power")
    def test_discharge_dynamic_prices_source_adapters_charging_power(self):
        return TODO

    @expect("source_adapters_consumption_ratios")
    def test_discharge_dynamic_prices_source_adapters_consumption_ratios(self):
        return TODO

    @expect("source_adapters_export_ratios")
    def test_discharge_dynamic_prices_source_adapters_export_ratios(self):
        return TODO

    @expect("source_adapters_charging_ratios")
    def test_discharge_dynamic_prices_source_adapters_charging_ratios(self):
        return TODO

    @expect("source_adapters_standby_ratios")
    def test_discharge_dynamic_prices_source_adapters_standby_ratios(self):
        return TODO

    @expect("source_adapters_consumption_shares")
    def test_discharge_dynamic_prices_source_adapters_consumption_shares(self):
        return TODO

    @expect("source_adapters_charging_shares")
    def test_discharge_dynamic_prices_source_adapters_charging_shares(self):
        return TODO

    @expect("source_adapters_standby_shares")
    def test_discharge_dynamic_prices_source_adapters_standby_shares(self):
        return TODO

    @expect("sink_adapters_consumption_shares")
    def test_discharge_dynamic_prices_sink_adapters_consumption_shares(self):
        return TODO
    ...
    @expect("source_adapters_coe_rate")
    def test_discharge_dynamic_prices_source_adapters_coe_rate(self):
        return TODO

    @expect("source_adapters_export_compensation_rates")
    def test_discharge_dynamic_prices_source_adapters_export_compensation_rates(self):
        return TODO

    @expect("source_adapters_coo_rates")
    def test_discharge_dynamic_prices_source_adapters_coo_rates(self):
        return TODO

    @expect("source_adapters_lcoo_rates")
    def test_discharge_dynamic_prices_source_adapters_lcoo_rates(self):
        return TODO

    @expect("sink_adapters_coo_rates")
    def test_discharge_dynamic_prices_sink_adapters_coo_rates(self):
        return TODO

    @expect("sink_adapters_lcoo_rates")
    def test_discharge_dynamic_prices_sink_adapters_lcoo_rates(self):
        return TODO

    @expect("sink_adapters_avoided_cost_rates")
    def test_discharge_dynamic_prices_sink_adapters_avoided_cost_rates(self):
        return TODO

    @expect("home_base_load_avoided_cost_rate")
    def test_discharge_dynamic_prices_home_base_load_avoided_cost_rate(self):
        return TODO

    @expect("combined_coe")
    def test_discharge_dynamic_prices_combined_coe(self):
        return TODO

    @expect("combined_lcoe")
    def test_discharge_dynamic_prices_combined_lcoe(self):
        return TODO

    @expect("combined_consumption_cost_rate")
    def test_discharge_dynamic_prices_combined_consumption_cost_rate(self):
        return TODO

    @expect("combined_levelized_consumption_cost_rate")
    def test_discharge_dynamic_prices_combined_levelized_consumption_cost_rate(self):
        return TODO

    @expect("combined_charging_cost_rate")
    def test_discharge_dynamic_prices_combined_charging_cost_rate(self):
        return TODO

    @expect("combined_levelized_export_cost_rate")
    def test_discharge_dynamic_prices_combined_levelized_export_cost_rate(self):
        return TODO

    @expect("combined_levelized_standby_cost_rate")
    def test_discharge_dynamic_prices_combined_levelized_standby_cost_rate(self):
        return TODO

    @expect("combined_device_operating_cost_rate")
    def test_discharge_dynamic_prices_combined_device_operating_cost_rate(self):
        return TODO

    @expect("adapters_saving_rates")
    def test_discharge_dynamic_prices_adapters_saving_rates(self):
        return TODO

    @expect("adapters_levelized_saving_rates")
    def test_discharge_dynamic_prices_adapters_levelized_saving_rates(self):
        return TODO

    @expect("adapters_financial_return_rates")
    def test_discharge_dynamic_prices_adapters_financial_return_rates(self):
        return TODO

    @expect("adapters_levelized_financial_return_rates")
    def test_discharge_dynamic_prices_adapters_levelized_financial_return_rates(self):
        return TODO

    @expect("combined_financial_return_rate")
    def test_discharge_dynamic_prices_combined_financial_return_rate(self):
        return TODO
