...
POWER_INSIGHT_PV_ADAPTER_SENSORS = (
    ...
    PowerInsightSensorDescription(
        ...
        suggested_display_precision=0,
        entities_fn=lambda obj: obj.source_entities_power,
        value_fn=lambda obj: obj.prod_adapters_charging_channel_ratios,
        transform_fn=lambda val: val * 100,
        charge_gated=True,
    ),
    PowerInsightSensorDescription(
        ...
        suggested_display_precision=0,
        entities_fn=lambda obj: obj.source_entities_power,
        value_fn=lambda obj: obj.prod_adapters_charging_channel_shares,
        transform_fn=lambda val: val * 100,
        charge_gated=True,
    ),
    PowerInsightSensorDescription(
...
POWER_INSIGHT_STORAGE_ADAPTER_SENSORS = (
    ...
    PowerInsightSensorDescription(
        ...
        suggested_display_precision=0,
        entities_fn=lambda obj: obj.source_entities_power,
        value_fn=lambda obj: obj.storage_adapters_charging_channel_ratios,
        transform_fn=lambda val: val * 100,
        charge_gated=True,
    ),
    PowerInsightSensorDescription(
        ...
        suggested_display_precision=0,
        entities_fn=lambda obj: obj.source_entities_power,
        value_fn=lambda obj: obj.storage_adapters_charging_channel_shares,
        transform_fn=lambda val: val * 100,
        charge_gated=True,
    ),
    PowerInsightSensorDescription(
