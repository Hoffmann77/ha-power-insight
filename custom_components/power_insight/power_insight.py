...
class PowerInsight:
    ...
    def combined_consumption_ratio(self) -> float | None:
        ...
        if (self_consumption := self.combined_consumption) is None:
            return None
    ...
    def applicable_self_consumption_share(self) -> float | None:
        ...
        if (self_cons_share := self.combined_consumption_share) is None:
            return None
    ...
    @property
    def grid_adapters_total_power_shares(self) -> float | None:
    ...
    def grid_adapters_consumption_ratios(self) -> float | None:
        ...
        applicable_share = self.applicable_consumption_ratio
    ...
    def grid_adapters_utilization_ratios(self) -> float | None:
        ...
        rates = {}
        # ???: use applicable share or not?
        applicable_share = self.applicable_combined_utilization_ratio
        if applicable_share is None:
            return {}
    ...
    def grid_adapters_consumption_shares(self) -> float | None:
        ...
        consumption_rates = self.grid_adapters_consumption_ratios
        total_power_shares = self.grid_adapters_total_power_shares
        for adapter in [self.grid_adapter]:
    ...
    def prod_adapters_export_rates(self) -> dict[str, float]:
        ...
        """
        export_rates = {}
        if (total_export_share := self.combined_export_ratio) is None:
            return {}
...
class BaseProductionAdapter(BasePowerProvidingAdapter):
    ...
    def _multiply_prod(self, value: float) -> float | None:
        ...
        if (prod := self.combined_production) is None:
            return None
